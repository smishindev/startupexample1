    ...
    items: [
      {
        ...
        testId: 'header-nav-admin-dashboard',
      },
      {
        id: 'admin-users',
        ...
        path: '/admin/users',
        icon: <PeopleIcon />,
        description: 'Manage users, roles & accounts',
        testId: 'header-nav-admin-users',
      },
      {
        id: 'admin-courses',
        ...
        testId: 'header-nav-admin-courses',
      },
      {
        id: 'admin-revenue',
        label: 'Revenue',
        ...
        description: 'Revenue analytics & transactions',
        testId: 'header-nav-admin-revenue',
      },
      {
        id: 'admin-reports',
        label: 'Reports',
        path: '/admin/reports',
        icon: <ReportsIcon />,
        description: 'Reports, audit log & system health',
        testId: 'header-nav-admin-reports',
      },
    ],
  },
];
