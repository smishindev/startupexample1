...
import instructorRevenueRoutes from './routes/instructorRevenue';
...
import instructorProfileRoutes from './routes/instructorProfile';
...
app.use('/api/instructor/revenue', instructorRevenueRoutes);
app.use('/api/instructor', instructorRoutes);
app.use('/api/instructors', instructorProfileRoutes);
